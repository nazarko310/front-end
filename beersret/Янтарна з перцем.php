                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Янтарна з перцем 32.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Янтарна з перцем</h1>
                                <ul>
                                    <li>Гостра</li>
                                    <li>Під будь-який алкоголь</li>
                                    <li>32 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Янтарна з перцем - Цей гоструватий делікатес можна вживати не тільки під пиво, а й інші алкогольні напої, а також насолоджуватися в моменти бажання скуштувати чогось «гарячого». </p>
                            </div>
