                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Філе тріски 36(1).jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Філе тріски</h1>
                                <ul>
                                    <li>Солодкий</li>
                                    <li>Солодкі та класичні сорти пива</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Філе тріски - Має приємний делікатний і злегка солодкий смак і солонуватий присмак. Чудово підходить до солодкуватих та класичних сортів пива.</p>
                            </div>
