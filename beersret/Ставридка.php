                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Ставридка 38(1).jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Ставридка</h1>
                                <ul>
                                    <li>Легка</li>
                                    <li>Популярна закуска до пива</li>
                                    <li>36 грн за 1 кг </li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Ставридка - є однією з популярних в багатьох країнах світу пивних закусок. Риба приготовлена таким чином, щоб її було дуже легко чистити. Для того, щоб її очистити, потрібно лише розламати її навпіл, зняти відокремилась шкірку і з'їсти м'якоть. </p>
                            </div>
