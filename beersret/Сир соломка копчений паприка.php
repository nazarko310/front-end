                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Сир соломка копч папр 24.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Сир соломка копчений з паприкою</h1>
                                <ul>
                                    <li>Молочний смак</li>
                                    <li>Має нотки гостроти</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Сир соломка копчений з папрікою - - поділений на соломки молочний сир з папріковою присипкою, щоб налати насиченості любому пиву яке буде напонювати ваш кухоль.</p>
                            </div>
