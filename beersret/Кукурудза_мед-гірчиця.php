                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Кукурудза мед-гір 24.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Кукурудза мед-гірчиця</h1>
                                <ul>
                                    <li>Хрустка</li>
                                    <li>Солодкувато-пряний смак</li>
                                    <li>Під світле і темне пиво</li>
                                    <li>24 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Кукурудза мед - гірчиця - хрустка закуска, виготовлена з обсмажених зерен кукурудзи. За відчуттями нагадує щось середнє між поп-корном і горішками. Має солодкувато-пряний, трохи гоструватий присмак меду і гірчиці. Добре поєднується зі світлими і темними сортами пива. </p>
                            </div>
