                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\НАПОЇ\Лимонад 20.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Лимонад</h1>
                                <ul>
                                    <li>Кисло-солодкий смак</li>
                                    <li>Корисний</li>
                                    <li>Без алкоголю</li>
                                    <li>20 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Лимонад - Напій має кисло-солодкий смак, чудово втамовує спрагу. Напій світло жовтуватого кольоруз додаванням натурального яблочного соку, без барвників, не містить консервантів.</p>
                            </div>
