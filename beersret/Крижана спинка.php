                ...
                <div class="product-beer">
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="pd product-beer__img ">
                                <img src="img\beerset_\ЗАКУСКИ\Крижана спинка 40.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Крижана спинка</h1>
                                <ul>
                                    <li>Сушене філе риби</li>
                                    <li>Світлі і темні сорти пива</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Крижана спинка - Смачне сушене філе риби крижана спинка на тонкій шкірці, яка легко відділяється, з додаванням солі. Добре поєднується зі світлими і темними сортами пива.</p>
                            </div>
