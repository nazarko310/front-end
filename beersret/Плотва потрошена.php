                    ...
                    <div class="container">
                        <div class="product-beer__grid ">
                            <div class="pd product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Плотва потрошена 29(1).jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Плотва потрошена</h1>
                                <ul>
                                    <li>Жирнувата</li>
                                    <li>Соковита</li>
                                    <li>До класичних сортів пива</li>
                                    <li>29 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Плотва патрана - одна з найпопулярніших закусок до пива. Злегка жирнувата, соковита має дуже смачне м'ясо. Якнайкраще підійде до класичних сортів пива. </p>
                            </div>
