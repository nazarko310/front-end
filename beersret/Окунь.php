                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Окунь 28.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                ...
                                <ul>
                                    <li>Ніжна</li>
                                    <li>Ароматна</li>
                                    <li>До світлих сортів пива</li>
                                    <li>28 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Окунь - м'ясо окуня ніжне, біле, нежирне, ароматне, має гарні смакові якості, крім того, у окуня порівняно мало кісток. Добре підійде до світлих сортів пива.</p>
                            </div>
