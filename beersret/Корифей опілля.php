                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\НАПОЇ\Корифей опілля 39.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Корифей опілля</h1>
                                <ul>
                                    <li>Темне</li>
                                    <li>Традиційний смак</li>
                                    <li>Солодкий аромат</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Корифей опілля - це пиво з традиційним смаком, яке люблять мільйони. Його золотистий колір і солодово-зернової аромат заворожує і дарує приємні миті.</p>
                            </div>
