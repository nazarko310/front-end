                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class=" pd product-beer__img ">
                                <img src="img\beerset_\ЗАКУСКИ\Анчоус 36.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Анчоус</h1>
                                <ul>
                                    <li>Солона з помірною гостротою</li>
                                    <li>Під будь-яке пиво</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Анчоус - Просочений ароматними спеціями, анчоус прекрасно поєднується з будь-яким пивом. На смак ця закуска відрізняється насиченою, але збалансованою солоністю з помірною гостротою. </p>
                            </div>
