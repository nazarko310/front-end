                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\НАПОЇ\Пшеничне 38.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                ...
                                <ul>
                                    <li>Світле</li>
                                    <li>Солодке</li>
                                    <li>З ароматом хліба та хмелю</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Пшеничне - Пиво відрізняється своїм неповторним, злегка солодкуватим смаком, золотистим кольором, ароматом хліба та приємним ароматом хмелю.</p>
                            </div>
