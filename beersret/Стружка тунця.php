                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="pd product-beer__img ">
                                <img src="img\beerset_\ЗАКУСКИ\Стружка тунця 36.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Стружка тунця</h1>
                                <ul>
                                    <li>Солодкий смак</li>
                                    <li>До світлого пива</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Стружка тунця - Має приємний делікатний і злегка солодкий смак. Чудово підходить до солодкуватих та класичних сортів світлого пива </p>
                            </div>
