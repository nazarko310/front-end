                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="pd product-beer__img ">
                                <img src="img\beerset_\ЗАКУСКИ\Телятина аджика 14 50.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Телятина аджика</h1>
                                <ul>
                                    <li>Суха</li>
                                    <li>Ароматна</li>
                                    <li>До будь-якого пива</li>
                                    <li>15 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Грінки телятина аджика - Сухі хлібці просякнуті вишуканим соусом телятини та аджики, що надає їм апетитний колір і аромат. Сміливо пробуйте грінки, не думаючи про незручності.</p>
                            </div>
