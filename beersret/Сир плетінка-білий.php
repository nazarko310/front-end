                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Сир плетінка білий 24.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Сир плетінка білий</h1>
                                <ul>
                                    <li>Солона</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Сир коса біла - Смак чистий, кисломолочний, підсолена, з присмаком і запахом молока. Консистенція мягка, розбтраться на насичені волокна за текстурою. Колір білий.</p>
                            </div>
