                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\ЗАКУСКИ\Ікряники 40.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Ікряники</h1>
                                <ul>
                                    <li>Приємний аромат</li>
                                    <li>Будь-які сторти пива</li>
                                    <li>40 грн за 1кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Ікряники - В'ялене м'ясо риби та ікра, спресовані в тоненькі трубочки бордового кольору. Мають приємний аромат. Пружні за своєю структурою, є відмінною закускою до будь-яких сортів пива.
                                </p>
                            </div>
