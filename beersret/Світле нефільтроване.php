                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\НАПОЇ\Світле нефільтроване хмільний лев 37.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Хмільний лев</h1>
                                <ul>
                                    <li>Світле нефільтроване</li>
                                    <li>Гіркувато-кислий</li>
                                    <li>Крафтове</li>
                                    <li>37 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Світле нефільтроване - Солодкава гіркота з переходом до легкої фруктової кислинки. Крафтове пиво, зварене по закону Райнгайтсґебот.</p>
                            </div>
