                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="product-beer__img">
                                <img src="img\beerset_\НАПОЇ\Квас 24.jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Старий добрий</h1>
                                <h1>Квас</h1>
                                <ul>
                                    <li>Втамовуэ спрагу</li>
                                    <li>На основі хлібної закваски</li>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Квас - зварений в найліпших традиціях бродіння. Хлібний квас не містить консервантів і домішків, натуральний продукт на основі хлібної закваски, втамує спрагу та надість наснаги.</p>
                            </div>
