                    ...
                    <div class="container">
                        <div class="product-beer__grid">
                            <div class="pd product-beer__img ">
                                <img src="img\beerset_\ЗАКУСКИ\Махан 50(1).jpg" alt="">
                            </div>
                            <div class="product-beer__text">
                                <h1>Махан</h1>
                                <ul>
                                    <li>Солона</li>
                                    <li>Вишукана закуска для гурманів</li>
                                    <li>Під будь-які сорти пива</li>
                                    <li>“Бургомістр”, Львів</li>
                                    <li>50 грн за 1 кг</li>
                                </ul>
                    ...
                    <div class="container">
                        <div class="product-benefits__grid">
                            <div class="product-benefits__text">
                                ...
                                <p>Махан - це сиров'ялена ковбаса, яка виготовляється з добірної конини з додаванням солі, спецій і цукру. Ковбаса має неповторний смак, і сподобається навіть самим вишуканим гурманам.</p>
                            </div>
