...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        $sql = "INSERT INTO booking (firstname, secondname, email, mobile, checkin, checkout, room) VALUES ('$firstname', '$secondname', '$email', '$number', '" . $_POST['checkin'] . "','" . $_POST['checkout'] . "', 'Standard Room')";
                ...
                <div class="container">
                    ...
                    <?php if (isset($massage)) {
                        ...
                        <div class="standart__inner">
                            <form action="standart.php" class="standart__form" method="post">
                                <div class="standart__form-inner">
                                    <div class="standart__form-inner_left">
                                        <label for="firstname">First Name</label>
                                        <input type="text" name="firstname" id="firstname" required>
                                        <label for="email">Email Address</label>
                                        <input type="email" name="email" id="email" required>
                                    </div>
                                    <div class="standart__form-inner_right">
                                ...
                                <div class="standart__form-datetimepicker">
                                    <div class="check-in">
                                ...
                                <input type="submit" class="standart__form-btn" value="Book">
                            </form>
                            <div class="standart__room">
                                <?php
                                require_once "db_conect.php";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '
			<div class = "standart__room-img">
				<img src = "img/booking/' . $row["image"] . '" alt = ""/>
            </div>
            <div class = "standart__room-content">
                <p class = "title">Room Type: ' . $row["title"] . '</p>
                <p>Size: 260 sq ft</p>
            </div>
                <div class = "standart__room-price">
                <p>From:</p>
