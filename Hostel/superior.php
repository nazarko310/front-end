...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        $sql = "INSERT INTO booking (firstname, secondname, email, mobile, checkin, checkout, room) VALUES ('$firstname', '$secondname', '$email', '$number', '" . $_POST['checkin'] . "','" . $_POST['checkout'] . "', 'Superior Room')";
            ...
            <div class="superior">
                <div class="container">
                    ...
                    <?php if (isset($massage)) {
                        ...
                        <div class="superior__inner">
                            <form action="superior.php" class="superior__form" method="post">
                                <div class="superior__form-inner">
                                    <div class="superior__form-inner_left">
                                        <label for="firstname">First Name</label>
                                        <input type="text" name="firstname" id="firstname" required>
                                        <label for="email">Email Address</label>
                                        <input type="email" name="email" id="email" required>
                                    </div>
                                    <div class="superior__form-inner_right">
                                ...
                                <div class="superior__form-datetimepicker">
                                    <div class="check-in">
                                ...
                                <input type="submit" class="superior__form-btn" value="Book">
                            </form>
                            <div class="superior__room">
                                <?php
                                require_once "db_conect.php";
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '
			<div class = "superior__room-img">
				<img src = "img/booking/' . $row["image"] . '" alt = ""/>
            </div>
            <div class = "superior__room-content">
                <p class = "title">Room Type: ' . $row["title"] . '</p>
                <p>Size: 260 sq ft</p>
            </div>
                <div class = "superior__room-price">
                <p>From:</p>
